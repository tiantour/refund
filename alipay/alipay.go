...
type (
	...
	Request struct {
		...
		OutRequestNo            string  `json:"out_request_no,omitempty" url:"out_request_no,omitempty"`                       // 否 退款单号
	...
	Query struct {
		...
		RefundAmount                 string `json:"refund_amount,omitempty" url:"refund_amount,omitempty"`                                     // 是 退款金额
